# Deployment Instructions - assistant.lease

This site is a static three-file bundle. The recommended path is **GitHub Pages with a custom domain**, keeping deployment entirely inside GitHub. Do not wire this through Vercel.
...
git config user.email "imc@icsmultimedia.com.au"
git add .
git commit -m "Initial commit - Assistant.Lease marketing site"
git branch -M main
```
